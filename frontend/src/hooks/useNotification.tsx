...
export const useNotification: React.FC<Props> = ({ duration, message }) => {
  ...
  return (
    <div>
      <div
        id="toast-default"
        className={`${visible ? "flex" : "hidden"} items-center w-full max-w-xs p-4 text-body bg-neutral-primary-soft rounded-base shadow-xs border border-default`}
        role="alert"
      >
        <svg
